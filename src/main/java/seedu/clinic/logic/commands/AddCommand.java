...
public class AddCommand extends Command {
    ...
    public static final String COMPLETE_ADD_SUPPLIER_COMMAND = "add ct/s n/ p/ e/ r/";
    public static final String COMPLETE_ADD_WAREHOUSE_COMMAND = "add ct/w n/ p/ addr/ r/";
