...
public class RemoveMacroCommand extends Command {
    ...
    public static final String MESSAGE_MACRO_DOES_NOT_EXIST = "Macro does not exist. You can check which macros"
            + " are presently saved by using the listmacro command.";
