...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditSupplierDescriptor descriptor = new EditSupplierDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withRemark(VALID_ADDRESS_AMY)
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        descriptor = new EditSupplierDescriptorBuilder().withRemark(VALID_ADDRESS_AMY).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        ...
        EditSupplierDescriptor descriptor = new EditSupplierDescriptorBuilder().withPhone(VALID_PHONE_BOB)
                .withEmail(VALID_EMAIL_BOB).withRemark(VALID_ADDRESS_BOB)
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        descriptor = new EditSupplierDescriptorBuilder().withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB)
                .withRemark(VALID_ADDRESS_BOB).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    public void parse_resetProducts_success() {
        ...
        EditSupplierDescriptor descriptor = new EditSupplierDescriptorBuilder().withProducts(Map.of()).build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
