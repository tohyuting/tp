...
public class FindCommandParserTest {
    ...
    public void parse_invalidType_throwsParseException() {
        ...
        assertParseFailure(parser, " ct/ps n/alex", String.format(FindCommand.MESSAGE_INVALID_TYPE,
                FindCommand.MESSAGE_USAGE));
        assertParseFailure(parser, " ct/pw pd/panadol",
                String.format(FindCommand.MESSAGE_INVALID_TYPE, FindCommand.MESSAGE_USAGE));
    }
